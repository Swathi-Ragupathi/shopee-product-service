...
import com.learn.microservices.shopeeproductservice.response.ErrorResponse;
import com.learn.microservices.shopeeproductservice.response.ValidationErrorResponse;

@RestControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	@ExceptionHandler(ProductException.class)
	protected ResponseEntity<?> handleGlobalException(ProductException userException, Locale locale) {
